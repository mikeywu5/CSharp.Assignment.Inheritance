   ...
   // [DebuggerNonUserCode]
    public class TypeAssert
    {
        ...
        public FieldInfo Field<FieldType>(string name, BindingFlags bindings)
        {
            ...
            FieldInfo fieldInfo = Type.GetFields(bindings).FirstOrDefault(f => f.Name == name && f.FieldType == fieldType);
            if (fieldInfo == null)
            {
        ...
        /// <summary>
        /// Asserts whether the class has the field or property
        /// </summary>
        /// <param name="name">Name.</param>
        /// <param name="bindings">Bindings.</param>
        public MemberInfo PropertyOrField<MemberType>(string name, BindingFlags bindings)
        {
            Type fieldType = typeof(MemberType);
            FieldInfo fieldInfo = Type.GetFields(bindings).FirstOrDefault(f => f.Name == name && f.FieldType == fieldType);
            if (fieldInfo == null)
            {
                var propertyInfo = Property<MemberType>(name, bindings);
                return propertyInfo;
            }
            return fieldInfo;
        }
        ...
        /// <param name="name">Name.</param>
        /// <param name="bindings">Bindings.</param>
        public MemberInfo NonPropertyAndField<MemberType>(string name, BindingFlags bindings)
        {
            Type fieldType = typeof(MemberType);
            FieldInfo fieldInfo = Type.GetFields(bindings).FirstOrDefault(f => f.Name == name && f.FieldType == fieldType);
            if (fieldInfo != null)
            {
                var propertyInfo = NonProperty<MemberType>(name, bindings);
                return propertyInfo;
            }
            return fieldInfo;
        }
        ...
        public PropertyInfo Property<ProperyType>(string name, BindingFlags bindings)
        {
            ...
            bool nonPublic = (bindings & BindingFlags.NonPublic) == BindingFlags.NonPublic;
            PropertyInfo propertyInfo = Type.GetProperty(name, bindings);
            MethodInfo get = nonPublic ? propertyInfo?.GetMethod : propertyInfo?.GetGetMethod(nonPublic);
            MethodInfo set = nonPublic ? propertyInfo?.SetMethod : propertyInfo?.GetSetMethod(nonPublic);
    ...
    {
        /// <summary>
        /// Asserts a field, property, method, or constructor as public.
        /// </summary>
        /// <param name="member"></param>
        /// <returns>member</returns>
        public static MemberInfo Public(this MemberInfo member)
        {
        ...
        /// <summary>
        /// Asserts a field, property, method, or constructor as protected.
        /// </summary>
        /// <param name="member"></param>
        /// <returns>member</returns>
        public static MemberInfo Protected(this MemberInfo member)
        {
            var field = member as FieldInfo;
            if (field != null)
            {
            ...
            Assert.Fail($"The member {member} must either be a member (field, property, method, or constructor) in the {member.DeclaringType.Name} class.");
            return member;
        }

        /// <summary>
        /// Asserts a field, property, method, or constructor as private.
        /// </summary>
        /// <param name="member"></param>
        /// <returns>member</returns>
        public static MemberInfo Private(this MemberInfo member)
        {
            var field = member as FieldInfo;
            if (field != null)
            {
        ...
        /// <returns>The field for chain of commands.</returns>
        /// <param name="field">Field.</param>
        public static MemberInfo ReadOnly(this MemberInfo member)
        {
            var field = member as FieldInfo;
            if (field != null)
            {
            ...
            if (property == null)
            {
                Assert.Fail($"The member {member} must either be a field or a property in the {member.DeclaringType.Name} class.");
            }
            property.ReadOnly();
            return member;
        }
        ...
        /// <summary>
        /// Assert a read-only property 
        /// </summary>
        /// <returns>The property for chain of commands.</returns>
        /// <param name="property">property.</param>
        public static PropertyInfo ReadOnly(this PropertyInfo property)
        {
            if (property.SetMethod != null || property.GetMethod == null || property.CanWrite || !property.CanRead)
            {
                Assert.Fail($"The property {property} must be read-only in the {property.DeclaringType.Name} class!");
            }
            return property;
        }
        ...
        public static MethodBase Public(this MethodBase method)
        {
            if (!method.IsPublic)
            {
        ...
        /// <returns>The method for chain of commands.</returns>
        /// <param name="method">Method.</param>
        public static MethodBase NonPublic(this MethodBase method)
        {
            if (method.IsPublic)
            {
        ...
        /// <returns>The method for chain of commands.</returns>
        /// <param name="method">Method.</param>
        public static MethodBase Private(this MethodBase method)
        {
            if (!method.IsPrivate)
            {
        ...
        /// <returns>The method for chain of commands.</returns>
        /// <param name="method">Method.</param>
        public static MethodBase Protected(this MethodBase method)
        {
            if (!method.IsFamily)
            {
                Assert.Fail($"The method {method} must be private in the {method.DeclaringType.Name} class.");
